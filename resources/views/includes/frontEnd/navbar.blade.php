        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse order-3 order-lg-2 justify-content-lg-end" id="navigation-menu">
                <ul class="navbar-nav my-3 my-lg-0">
                    ...
                    <li class="nav-item">
                        <a aria-expanded="false" class="nav-link nav-item" href="./our_service.php" role="button">Service</a>
                    </li>
                    <li class="nav-item">
                        <a aria-expanded="false" class="nav-link nav-item" href="./about.php" role="button">About</a>
                    </li>
                    <li class="nav-item">
                        <a aria-expanded="false" class="nav-link nav-item" href="./contact.php" role="button">Contact</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="row dropdown-menu" style="left: -1197px;">
                                <div class="col-auto" data-dropdown-content="" style="left: 1197px;">
                                    <div class="dropdown-grid-menu">
                                        <a href="tutorials.php" class="dropdown-item">Tutorials</a>
                                        <a href="screenshots.php" class="dropdown-item">Screenshots</a>
                                        <a href="public_uploads/Brochure.pdf" target="_blank" class="dropdown-item">Brochure</a>
