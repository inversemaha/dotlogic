    ...
    <div class="cui__topbar">
        <div class="mr-4">
            <a href="/admin/dashboard" class="mr-2">
                <i
                    class="dropdown-toggle-icon fe fe-home"
                    data-toggle="tooltip"
        ...
        <div class="dropdown mr-4 d-none d-sm-block">
            ...
            <div class="dropdown-menu dropdown-menu-right" role="menu">
                ...
                ><span class="text-uppercase font-size-12 mr-1">EN</span> English</a
                >
                {{--<a class="dropdown-item" href="javascript:void(0)"
                ><span class="text-uppercase font-size-12 mr-1">FR</span> French</a
                >--}}
            </div>
        </div>
        ...
        <div class="dropdown">
            ...
            >
                <img
                    ...
                    src="/admin/components/kit/core/img/avatars/avatar-2.png"
                    alt="User avatar"
                />
            </a>
            <div class="dropdown-menu dropdown-menu-right" role="menu">
