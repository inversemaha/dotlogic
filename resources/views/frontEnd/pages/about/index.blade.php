...
@section('content')
    <div data-overlay="" class="o-hidden" style="padding-top: 80px !important;">
        <section class="pb-0">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="d-flex flex-column flex-lg-row no-gutters border rounded bg-white o-hidden">
                            <a href="#" class="d-block position-relative bg-gradient col-xl-6 order-lg-2">
                                ...
                                <img class="card-img-top flex-fill hover-fade-out" src="/assets/img/case-studies/thumb-1.jpg" alt="Image accompanying Amara testimonial">
                                <div class="badge badge-light badge-pill">
                                    <img src="/assets/img/logos/brand/aven.svg" alt="Aven company logo" class="icon icon-sm m-1 m-lg-2">
                                </div>
                            </a>
                            <div class="p-4 p-md-5 col-xl">
                                <div class="p-lg-4 p-xl-5">
                                    <h1>&ldquo;We are working at almost twice the capacity&rdquo;</h1>
                                    <p class="lead">
            ...
            <div class="position-absolute bottom left w-50 h-50 d-none d-md-block" data-jarallax-element="-24 48"
                 style="z-index: 0; transform: translate3d(-7.46474px, 3.73237px, 0px);">
            ...
            <div class="position-absolute top right w-50 h-50 d-none d-md-block" data-jarallax-element="48"
                 style="z-index: 0; transform: translate3d(0px, 24.0417px, 0px);">
        ...
        <div class="container">
            <div class="row section-title justify-content-center text-center">
                <div class="col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="lead">
                        Sales System BD is providing efficient software and solutions that are intended to manage and improve all aspects of the business process. Our core services are Inventory Control, POS and Service Management. Our team is fully dedicated to transform customer’s wish list into customized software that meets the client’s business needs. Following the best practice, we apply different project management methodologies depending on the features of the project to ensure a quality product. Clients satisfaction is our top priority.
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <div class="row align-items-center justify-content-around text-center text-lg-left">
                <div class="col-md-9 col-lg-6 col-xl-5 mb-4 mb-md-5 mb-lg-0 order-lg-2 aos-init aos-animate" data-aos="fade-in">
                    <h2 class="h1">We’re an aspiring team of coders and creatives</h2>
                    <a href="#" class="lead">Check this out</a>
                </div>
                <div class="col-md-9 col-lg-6 col-xl-5 order-lg-1 aos-init aos-animate" data-aos="fade-in">
                    <img src="assets/img/about-2.jpg" alt="Image" class="img-fluid rounded shadow">
                    <img src="assets/img/about-2a.jpg" alt="Image" class="position-absolute p-0 col-4 col-xl-5 border border-white border-thick rounded-circle top left shadow-lg mt-5 ml-n5 ml-lg-n3 ml-xl-n5 d-none d-md-block" data-jarallax-element="-20 0" style="z-index: 0; transform: translate3d(0px, -6.0203px, 0px);">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center justify-content-around text-center text-lg-left">
                <div class="col-md-9 col-lg-6 col-xl-5 mb-4 mb-md-5 mb-lg-0 pl-lg-5 pl-xl-0">
                    ...
                    <div class="d-flex flex-wrap justify-content-center justify-content-lg-start">
                        ...
                        <div class="mb-3 mr-4 ml-lg-0 mr-lg-4 aos-init aos-animate" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div class="mb-3 mr-4 ml-lg-0 mr-lg-4 aos-init aos-animate" data-aos="fade-left" data-aos-delay="100">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle bg-success-alt">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="injected-svg m-2 icon icon-xs bg-success" data-src="assets/img/icons/interface/icon-check.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <path d="M20 6L9 17L4 12" stroke="#2C3038" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        ...
                        <div class="mb-3 mr-4 ml-lg-0 mr-lg-4 aos-init aos-animate" data-aos="fade-left" data-aos-delay="200">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle bg-success-alt">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="injected-svg m-2 icon icon-xs bg-success" data-src="assets/img/icons/interface/icon-check.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <path d="M20 6L9 17L4 12" stroke="#2C3038" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        ...
                        <div class="mb-3 mr-4 ml-lg-0 mr-lg-4 aos-init aos-animate" data-aos="fade-left" data-aos-delay="400">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle bg-success-alt">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="injected-svg m-2 icon icon-xs bg-success" data-src="assets/img/icons/interface/icon-check.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <path d="M20 6L9 17L4 12" stroke="#2C3038" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <div class="col-md-9 col-lg-6 col-xl-5 aos-init aos-animate" data-aos="fade-in" data-aos-offset="250">
