                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/admin/licences/store" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" placeholder="Serial No"
                                                       name="serial_no" ng-model="serial_no" required>
                                            </div>
                                            <div class="col-md-4">
                                                <button ng-click="generateLicence()" class="btn btn-sm btn-success" type="button">Generate</button>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="License No"
                                                       name="license_no"  ng-model="license_no" readonly>
                                            </div>
                                        </div>
                                        {{--<div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="mb-5">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Valid Date" id="datepicker-valid_date"
                                                                   data-toggle="datetimepicker" name="valid_date" data-target="#datepicker-valid_date" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="mb-5">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Last Access Time" id="datepicker-last_access"
                                                                   data-toggle="datetimepicker" name="last_access_time" data-target="#datepicker-last_access" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
